...
// 1. seller.html
let shitesi = fs.readFileSync('seller.html', 'utf8');
...
fs.writeFileSync('seller.html', shitesi, 'utf8');

// 2. sell.html
let shit = fs.readFileSync('sell.html', 'utf8');
...
fs.writeFileSync('sell.html', shit, 'utf8');
...
fs.writeFileSync('women.html', femra, 'utf8');

// 5. men.html
let meshkuj = fs.readFileSync('men.html', 'utf8');
...
fs.writeFileSync('men.html', meshkuj, 'utf8');

// 6. product.html
let produkt = fs.readFileSync('product.html', 'utf8');
...
fs.writeFileSync('product.html', produkt, 'utf8');

// 7. Update Navlinks
const files = fs.readdirSync('.').filter(f => f.endsWith('.html'));
for (const f of files) {
    let content = fs.readFileSync(f, 'utf8');
    content = content.replace(/<li><a href="meshkuj\.html"[^>]*>Meshkuj<\/a><\/li>(\s*<li><a href="kepuce\.html">Këpucë<\/a><\/li>\s*<li><a href="aksesore\.html">Aksesorë<\/a><\/li>)?/g, '<li><a href="men.html">Meshkuj</a></li>\n                <li><a href="shoes.html">Këpucë</a></li>\n                <li><a href="accessories.html">Aksesorë</a></li>');
